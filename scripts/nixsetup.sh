...
kdePackages.kdenlive libreoffice librewolf love lua luajit neofetch nodejs_22 obs-studio \
...
yt-dlg zoom-us go"
# Other Packages: luarocks, samsung-magician, nordvpn, nvidia, jdk21-src, jdk21-doc, minecraft
