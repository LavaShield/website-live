# Winget Packages
winget install LibreWolf.LibreWolf Intel.IntelDriverAndSupportAssistant qBittorrent.qBittorrent ^
...
Mozilla.Thunderbird OpenJS.NodeJS.LTS NordVPN.NordVPN GOG.Galaxy Flameshot.Flameshot FreeCAD.FreeCAD ^
GIMP.GIMP DolphinEmulator.Dolphin JGraph.Draw KDE.Kdenlive TheDocumentFoundation.LibreOffice ^
