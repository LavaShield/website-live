...
general_Packages="base-devel cinnamon curl dosfstools exfat-utils gcc git gnome 
                  ...
                  openjdk21-src p7zip python timeshift tmux gvim 
...
desktop_Packages="audacity bitwarden bluez bluez-utils code cups 
                  filezilla flameshot gimp libreoffice-fresh 
                  neofetch obs-studio opensnitch 
                  qbittorrent signal-desktop sqlitebrowser
