...
# Package Groups
general_Packages="base-devel cinnamon curl dosfstools exfat-utils gcc git gnome gnome-extra htop jdk21-openjdk ntfs-3g
...
server_Packages="docker docker-compose openssh screen ufw"
server_Aur_Packages=""
